...
const comandos = {
    ...
    "JARVIS conoces a mi mamá": () => {
        voz("Si, tu mamá se llama Jovita Isabel Villalva Alvarado");
        voz("Ella vive en la Localidad de Chiquitoy");
        annyang.abort()
    },
    ...
    "quién te creo": () => {
        voz("Mi creador es Sanchez Villalva Luis Gustavo");
        voz("Actualmente tiene dicesinueve años y esta estudiando la carrera de Ingenieria de Sistemas y va por el 6to ciclo ");
    },

    "qué eres": () => {
        voz("soy un asistente virtual, que esta en pleno proceso de prueba, pero, pronto estare terminado ");
    },

    "cuál es tu nombre": () => {
        voz("mi nombre es JARVIS");
    },
    ...
    "Te presento a *nombre": nombre => {
        voz("Hola" + nombre +", mi nombre es JARVIS, es un placer conocerte");
    },
